...
bool ImGui::InputFloat2(const char* label, float *x, float *y, int decimal_precision, ImGuiInputTextFlags extra_flags)
{
  float v[2] = {*x, *y};
  bool ret = InputFloatN(label, v, 2, decimal_precision, extra_flags);
  *x = v[0];
  *y = v[1];
  return ret;
}
