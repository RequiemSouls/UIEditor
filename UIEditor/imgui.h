...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloat2(const char* label, float *x, float *y, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.3f", float power = 1.0f);
    ...
    IMGUI_API bool          InputFloat2(const char* label, float *x, float *y, int decimal_precision = -1, ImGuiInputTextFlags extra_flags = 0);
